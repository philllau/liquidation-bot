...
export class IReserveV1 extends Contract {
  ...
  functions: {
    ...
    "calculateBorrow(uint256,uint256)"(
      amount: BigNumberish,
      rateMultiplier: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { borrowRate: BigNumber }>;
    ...
    "calculateWithdraw(uint256,address)"(
      amount: BigNumberish,
      investor: string,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
  ...
  estimateGas: {
    ...
    deposit(investor: string, overrides?: Overrides): Promise<BigNumber>;
    ...
    liquidate(trader: string, overrides?: Overrides): Promise<BigNumber>;
