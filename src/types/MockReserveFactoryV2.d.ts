...
interface MockReserveFactoryV2Interface extends ethers.utils.Interface {
  functions: {
...
export class MockReserveFactoryV2 extends Contract {
  ...
  interface: MockReserveFactoryV2Interface;
