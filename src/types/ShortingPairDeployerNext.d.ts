...
export class ShortingPairDeployerNext extends Contract {
  ...
  functions: {
    ...
    getPairImplementation(overrides?: Overrides): Promise<ContractTransaction>;
  ...
  estimateGas: {
    ...
    getPairImplementation(overrides?: Overrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getPairImplementation(overrides?: Overrides): Promise<PopulatedTransaction>;
