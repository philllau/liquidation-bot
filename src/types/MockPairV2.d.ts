...
interface MockPairV2Interface extends ethers.utils.Interface {
  functions: {
    ...
    "initialize(address,address,address,address,address,address,string,string)": FunctionFragment;
...
export class MockPairV2 extends Contract {
