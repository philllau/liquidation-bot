...
export class Referral extends Contract {
  ...
  functions: {
    ...
    "availableClaim(address,address)"(
      trader: string,
      token: string,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
    ...
    "calculateRewards(address,address,uint256)"(
      trader: string,
      token: string,
      volume: BigNumberish,
      overrides?: CallOverrides
    ...
    "distributeRewardIncentivized(address,address,uint256)"(
      trader: string,
      token: string,
      volume: BigNumberish,
      overrides?: Overrides
    ...
    register(overrides?: Overrides): Promise<ContractTransaction>;
    ...
    "setReferralAdmin(address,address)"(
      referrer: string,
      referral: string,
      overrides?: Overrides
    ): Promise<ContractTransaction>;
  ...
  claimAll(trader: string, overrides?: Overrides): Promise<ContractTransaction>;
  ...
  estimateGas: {
    ...
    claimAll(trader: string, overrides?: Overrides): Promise<BigNumber>;
    ...
    incentivize(token: string, overrides?: Overrides): Promise<BigNumber>;
    ...
    register(overrides?: Overrides): Promise<BigNumber>;
    ...
    setPairFactory(value: string, overrides?: Overrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    register(overrides?: Overrides): Promise<PopulatedTransaction>;
